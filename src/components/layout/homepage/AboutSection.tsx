...
const AboutSection = () => {
  ...
  return (
    <section className="relative w-full h-auto lg:h-[120vh] min-h-screen lg:min-h-[900px] bg-[#0A0A0A] overflow-hidden flex flex-col items-center justify-center pt-24 pb-16 lg:py-32">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center text-center max-w-5xl mx-auto px-5 pointer-events-none">
        <h2 className="text-[3.25rem] md:text-8xl lg:text-[8rem] font-serif tracking-tight text-[#E8DCC4] leading-[0.9] drop-shadow-2xl">
      ...
      <div className="lg:hidden w-full px-5 mt-16 relative z-10 grid grid-cols-2 gap-4 max-w-sm mx-auto">
        <div className="col-span-1 rounded-sm overflow-hidden border-2 border-[#3a3528] shadow-lg transform -rotate-2">
          <img
            src="https://i.pinimg.com/736x/12/bf/09/12bf091a93c2096643854053bb700a9b.jpg"
        ...
        <div className="col-span-1 rounded-sm overflow-hidden border-2 border-[#413b2c] shadow-lg transform rotate-2">
          <img
            src="https://i.pinimg.com/1200x/78/a4/3a/78a43a04e53830e67f44d4e541f39bae.jpg"
        ...
        <div className="col-span-2 rounded-sm overflow-hidden border-4 border-[#2A261E] shadow-2xl mt-2 transform rotate-1">
          <img
            src="https://astrologeratultripathi.com/wp-content/uploads/2026/02/WhatsApp_Image_2025-02-25_at_1.41.07_PM-removebg-preview.webp"
